...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
        //----------------------------------                            -------------------------------------
        KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, ES_SCLN, ES_ACUT, ES_ASTR, ES_QUOT, ES_DQUO, KC_BSPC,
        //----------------------------------                            -------------------------------------
        KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_DEL,
        //----------------------------------                            -------------------------------------
        KC_LSFT, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_HOME,
        //----------------------------------                            -------------------------------------
        KC_LCTRL, KC_Z, KC_X, KC_C, KC_V, KC_B, ES_LPRN, ES_RPRN, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_END,
        //----------------------------------                            -------------------------------------
    ...
    [_LOWER] = LAYOUT(
        ...
        //----------------------------------                            -------------------------------------
        _______, _______, _______, _______, _______, _______, ES_SLSH, ES_BSLS, ES_PIPE, ES_ASTR, ES_PLUS, _______,
        //----------------------------------                            -------------------------------------
    ...
    [_RAISE] = LAYOUT(
        ...
        //----------------------------------                            -------------------------------------
        _______, _______, _______, ES_MINS, ES_PLUS, ES_EQL, _______, _______, _______, _______, _______, _______,
        //----------------------------------                            -------------------------------------
        _______, _______, _______, _______, ES_LABK, ES_RABK, _______, _______, _______, _______, _______, _______,
        //----------------------------------                            -------------------------------------
